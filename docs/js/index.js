...
var Dots = (function () {
    function Dots(dom) {
        this.dom = dom;
        this.uniqueClass = "enable";
        this.maxLen = this.dom.children().length - 1;
        this.setUniqueClass(0);
    }
    Dots.prototype.next = function () {
        var currentDot = this.getCurrentDot();
        this.removeDots();
    ...
    Dots.prototype.getCurrentDot = function () {
        return this.dom.children("." + this.uniqueClass).index();
    };
    Dots.prototype.setUniqueClass = function (index) {
...
var WindowColor = (function () {
    function WindowColor(dom) {
        this.dom = dom;
    }
    WindowColor.prototype.setColor = function () {
        this.dom.css({ backgroundColor: this.generateColor() });
    };
    WindowColor.prototype.generateColor = function () {
        var randomColor = "#" + ("000000" + (Math.random() * 0xFFFFFF | 0).toString(16)).slice(-6);
        return randomColor;
    };
    return WindowColor;
}());
exports.default = WindowColor;
...
$(function () {
    ...
    var moveDots = function (e, dots, func) {
        windowColor.setColor();
        var direction = func(e);
        if (direction === 1) {
            dots.next();
        }
        else if (direction === -1) {
    ...
    var dotsWheelThrottle = new Dots_1.default($("#wheelthrottle .dots"));
    var getDirection1 = function (e) { return e.detail.direction; };
    var wheelThrottle = new WheelThrottle_1.default(document.getElementById("wheelthrottle"));
    wheelThrottle.addWheelThrottle(function (e) { return moveDots(e, dotsWheelThrottle, getDirection1); });
    var dotsWheel = new Dots_1.default($("#wheel .dots"));
    var getDirection2 = function (e) { return Math.sign(e.deltaY || e.detail); };
    var wheel = document.getElementById("wheel");
    if (wheel)
        wheel.addEventListener("wheel", function (e) { return moveDots(e, dotsWheel, getDirection2); });
});
...
/***/ 0:
/*!*************************************************!*\
  !*** multi ./script/index.ts ./sass/index.scss ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\Users\drbob\repos\private\wheelthrottle\script\index.ts */"./script/index.ts");
module.exports = __webpack_require__(/*! C:\Users\drbob\repos\private\wheelthrottle\sass\index.scss */"./sass/index.scss");
